...
/**
 * Protobuf message : PkgClient.Protocol.Message.FortSearchRequest
 */
class FortSearchRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\FortSearchRequest) {
