...
/**
 * Protobuf message : PkgClient.Protocol.Message.Currency
 */
class Currency extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->type === null) {
            throw new \UnexpectedValueException('Field "\\PkgClient\\Protocol\\Message\\Currency#type" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\Currency) {
