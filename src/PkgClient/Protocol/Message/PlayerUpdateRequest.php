...
/**
 * Protobuf message : PkgClient.Protocol.Message.PlayerUpdateRequest
 */
class PlayerUpdateRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\PlayerUpdateRequest) {
