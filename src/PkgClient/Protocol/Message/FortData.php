...
/**
 * Protobuf message : PkgClient.Protocol.Message.FortData
 */
class FortData extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \PkgClient\Protocol\Enum\FortSponsor
     */
     ...
     *
     * @var \PkgClient\Protocol\Message\FortLureInfo
     */
     ...
     * Set 'type' value
     *
     * @param \PkgClient\Protocol\Enum\FortType $value
     */
    public function setType(\PkgClient\Protocol\Enum\FortType $value = null)
    {
        $this->type = $value;
    }
     ...
     */
    public function setOwnedByTeam(\PkgClient\Protocol\Enum\TeamColor $value = null)
    {
     ...
     */
    public function setGuardPokemonId(\PkgClient\Protocol\Enum\PokemonId $value = null)
    {
     ...
     * Get 'sponsor' value
     *
     * @return \PkgClient\Protocol\Enum\FortSponsor
     */
     ...
     * Set 'sponsor' value
     *
     * @param \PkgClient\Protocol\Enum\FortSponsor $value
     */
    public function setSponsor(\PkgClient\Protocol\Enum\FortSponsor $value = null)
    {
        $this->sponsor = $value;
    }
     ...
     *
     * @param \PkgClient\Protocol\Enum\FortRenderingType $value
     */
    public function setRenderingType(\PkgClient\Protocol\Enum\FortRenderingType $value = null)
    {
     ...
     * Get 'lure_info' value
     *
     * @return \PkgClient\Protocol\Message\FortLureInfo
     */
     ...
     * Set 'lure_info' value
     *
     * @param \PkgClient\Protocol\Message\FortLureInfo $value
     */
    public function setLureInfo(\PkgClient\Protocol\Message\FortLureInfo $value = null)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.PkgClient.Protocol.Enum.FortType'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 5,
                    'name' => 'owned_by_team',
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_ENUM(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.PkgClient.Protocol.Enum.FortSponsor'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 16,
                    'name' => 'rendering_type',
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_ENUM(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.PkgClient.Protocol.Enum.FortRenderingType'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 12,
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.PkgClient.Protocol.Message.FortLureInfo'
                ]),
            ],
        ]);
    }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 9) {
                ...
                $this->type = \PkgClient\Protocol\Enum\FortType::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 5) {
                ...
                $this->owned_by_team = \PkgClient\Protocol\Enum\TeamColor::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 6) {
                ...
                $this->guard_pokemon_id = \PkgClient\Protocol\Enum\PokemonId::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 15) {
                ...
                $this->sponsor = \PkgClient\Protocol\Enum\FortSponsor::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 16) {
                ...
                $this->rendering_type = \PkgClient\Protocol\Enum\FortRenderingType::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 13) {
                ...
                $innerMessage = new \PkgClient\Protocol\Message\FortLureInfo();
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\FortData) {
