...
/**
 * Protobuf message : PkgClient.Protocol.Message.EncounterRequest
 */
class EncounterRequest extends \Protobuf\AbstractMessage
{
    ...
    /**
     * spawnpoint_id optional string = 2
     *
     * @var string
     */
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\EncounterRequest) {
