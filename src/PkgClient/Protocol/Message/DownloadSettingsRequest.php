...
/**
 * Protobuf message : PkgClient.Protocol.Message.DownloadSettingsRequest
 */
class DownloadSettingsRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\DownloadSettingsRequest) {
