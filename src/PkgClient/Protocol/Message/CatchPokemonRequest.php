...
/**
 * Protobuf message : PkgClient.Protocol.Message.CatchPokemonRequest
 */
class CatchPokemonRequest extends \Protobuf\AbstractMessage
{
    ...
    /**
     * spawn_point_guid optional string = 4
     *
     * @var string
     */
    ...
    /**
     * NormalizedHitPosition optional double = 7
     *
     * @var float
     */
    protected $NormalizedHitPosition = null;
    ...
    /**
     * Check if 'NormalizedHitPosition' has a value
     *
     * @return bool
     */
    public function hasNormalizedHitPosition()
    {
        return $this->NormalizedHitPosition !== null;
    }

    /**
     * Get 'NormalizedHitPosition' value
     *
     * @return float
     */
    ...
    /**
     * Set 'NormalizedHitPosition' value
     *
     * @param float $value
     */
    public function setNormalizedHitPosition($value = null)
    {
        $this->NormalizedHitPosition = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $message->setNormalizedHitPosition($values['NormalizedHitPosition']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->NormalizedHitPosition !== null) {
            $writer->writeVarint($stream, 57);
            $writer->writeDouble($stream, $this->NormalizedHitPosition);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 7) {
                ...
                $this->NormalizedHitPosition = $reader->readDouble($stream);
    ...
    public function clear()
    {
        ...
        $this->NormalizedHitPosition = null;
    }
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\CatchPokemonRequest) {
        ...
        $this->NormalizedHitPosition = ($message->NormalizedHitPosition !== null) ? $message->NormalizedHitPosition : $this->NormalizedHitPosition;
    }
