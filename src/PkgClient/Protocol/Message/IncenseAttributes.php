...
/**
 * Protobuf message : PkgClient.Protocol.Message.IncenseAttributes
 */
class IncenseAttributes extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\PkgClient\Protocol\Enum\PokemonType>
     */
     ...
     *
     * @return \Protobuf\Collection<\PkgClient\Protocol\Enum\PokemonType>
     */
     ...
     *
     * @param \Protobuf\Collection<\PkgClient\Protocol\Enum\PokemonType> $value
     */
     ...
     */
    public function addPokemonType(\PkgClient\Protocol\Enum\PokemonType $value)
    {
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->pokemon_type->add(\PkgClient\Protocol\Enum\PokemonType::valueOf($reader->readVarint($stream)));
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\IncenseAttributes) {
