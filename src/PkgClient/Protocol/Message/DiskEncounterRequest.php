...
/**
 * Protobuf message : PkgClient.Protocol.Message.DiskEncounterRequest
 */
class DiskEncounterRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\DiskEncounterRequest) {
