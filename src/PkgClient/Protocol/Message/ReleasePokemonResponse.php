...
/**
 * Protobuf message : PkgClient.Protocol.Message.ReleasePokemonResponse
 */
class ReleasePokemonResponse extends \Protobuf\AbstractMessage
{
     ...
     * Set 'result' value
     *
     * @param \PkgClient\Protocol\Message\ReleasePokemonResponse\Result $value
     */
    public function setResult(\PkgClient\Protocol\Message\ReleasePokemonResponse\Result $value = null)
    {
        $this->result = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.PkgClient.Protocol.Message.ReleasePokemonResponse.Result'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'candy_awarded',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->result = \PkgClient\Protocol\Message\ReleasePokemonResponse\Result::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\ReleasePokemonResponse) {
