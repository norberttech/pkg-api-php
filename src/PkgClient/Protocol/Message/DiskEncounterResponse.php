...
/**
 * Protobuf message : PkgClient.Protocol.Message.DiskEncounterResponse
 */
class DiskEncounterResponse extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \PkgClient\Protocol\Message\DiskEncounterResponse\Result
     */
     ...
     * Get 'result' value
     *
     * @return \PkgClient\Protocol\Message\DiskEncounterResponse\Result
     */
     ...
     * Set 'result' value
     *
     * @param \PkgClient\Protocol\Message\DiskEncounterResponse\Result $value
     */
    public function setResult(\PkgClient\Protocol\Message\DiskEncounterResponse\Result $value = null)
    {
        $this->result = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.PkgClient.Protocol.Message.DiskEncounterResponse.Result'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'pokemon_data',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->result = \PkgClient\Protocol\Message\DiskEncounterResponse\Result::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\DiskEncounterResponse) {
