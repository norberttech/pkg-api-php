...
/**
 * Protobuf message : PkgClient.Protocol.Message.FortSearchResponse.ItemAward
 */
class ItemAward extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\FortSearchResponse\ItemAward) {
