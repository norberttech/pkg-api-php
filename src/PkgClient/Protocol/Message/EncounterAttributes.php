...
/**
 * Protobuf message : PkgClient.Protocol.Message.EncounterAttributes
 */
class EncounterAttributes extends \Protobuf\AbstractMessage
{
     ...
     */
    public function setMovementType(\PkgClient\Protocol\Enum\PokemonMovementType $value = null)
    {
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 6) {
                ...
                $this->movement_type = \PkgClient\Protocol\Enum\PokemonMovementType::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\EncounterAttributes) {
