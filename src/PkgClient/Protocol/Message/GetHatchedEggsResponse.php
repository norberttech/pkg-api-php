...
/**
 * Protobuf message : PkgClient.Protocol.Message.GetHatchedEggsResponse
 */
class GetHatchedEggsResponse extends \Protobuf\AbstractMessage
{
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                while ($stream->tell() < $innerLimit) {
                    $this->pokemon_id->add($reader->readVarint($stream));
                }
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\GetHatchedEggsResponse) {
