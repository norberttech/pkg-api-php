...
/**
 * Protobuf message : PkgClient.Protocol.Message.CameraSettings
 */
class CameraSettings extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\PkgClient\Protocol\Enum\CameraInterpolation>
     */
     ...
     *
     * @var \Protobuf\Collection<\PkgClient\Protocol\Enum\CameraTarget>
     */
     ...
     *
     * @return \Protobuf\Collection<\PkgClient\Protocol\Enum\CameraInterpolation>
     */
     ...
     *
     * @param \Protobuf\Collection<\PkgClient\Protocol\Enum\CameraInterpolation> $value
     */
     ...
     *
     * @param \PkgClient\Protocol\Enum\CameraInterpolation $value
     */
    public function addInterpolation(\PkgClient\Protocol\Enum\CameraInterpolation $value)
    {
     ...
     *
     * @return \Protobuf\Collection<\PkgClient\Protocol\Enum\CameraTarget>
     */
     ...
     *
     * @param \Protobuf\Collection<\PkgClient\Protocol\Enum\CameraTarget> $value
     */
     ...
     *
     * @param \PkgClient\Protocol\Enum\CameraTarget $value
     */
    public function addTargetType(\PkgClient\Protocol\Enum\CameraTarget $value)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.PkgClient.Protocol.Enum.CameraInterpolation'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 3,
                    'name' => 'target_type',
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_ENUM(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_REPEATED(),
                    'type_name' => '.PkgClient.Protocol.Enum.CameraTarget'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 4,
                    'name' => 'ease_in_speed',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->interpolation->add(\PkgClient\Protocol\Enum\CameraInterpolation::valueOf($reader->readVarint($stream)));
            ...
            if ($tag === 3) {
                ...
                $this->target_type->add(\PkgClient\Protocol\Enum\CameraTarget::valueOf($reader->readVarint($stream)));
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\CameraSettings) {
