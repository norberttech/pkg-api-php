...
/**
 * Protobuf message : PkgClient.Protocol.Message.MoveSettings
 */
class MoveSettings extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \PkgClient\Protocol\Enum\PokemonMovementType
     */
     ...
     *
     * @return \PkgClient\Protocol\Enum\PokemonMovementType
     */
     ...
     *
     * @param \PkgClient\Protocol\Enum\PokemonMovementType $value
     */
    public function setMovementId(\PkgClient\Protocol\Enum\PokemonMovementType $value = null)
    {
     ...
     */
    public function setPokemonType(\PkgClient\Protocol\Enum\PokemonType $value = null)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.PkgClient.Protocol.Enum.PokemonMovementType'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'animation_id',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->movement_id = \PkgClient\Protocol\Enum\PokemonMovementType::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 3) {
                ...
                $this->pokemon_type = \PkgClient\Protocol\Enum\PokemonType::valueOf($reader->readVarint($stream));
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\MoveSettings) {
