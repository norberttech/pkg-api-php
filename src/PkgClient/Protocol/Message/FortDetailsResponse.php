...
/**
 * Protobuf message : PkgClient.Protocol.Message.FortDetailsResponse
 */
class FortDetailsResponse extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\PkgClient\Protocol\Message\FortModifier>
     */
     ...
     */
    public function setTeamColor(\PkgClient\Protocol\Enum\TeamColor $value = null)
    {
     ...
     */
    public function setPokemonData(\PkgClient\Protocol\Message\PokemonData $value = null)
    {
     ...
     * Get 'modifiers' value
     *
     * @return \Protobuf\Collection<\PkgClient\Protocol\Message\FortModifier>
     */
     ...
     * Set 'modifiers' value
     *
     * @param \Protobuf\Collection<\PkgClient\Protocol\Message\FortModifier> $value
     */
     ...
     *
     * @param \PkgClient\Protocol\Message\FortModifier $value
     */
    public function addModifiers(\PkgClient\Protocol\Message\FortModifier $value)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_MESSAGE(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_REPEATED(),
                    'type_name' => '.PkgClient.Protocol.Message.FortModifier'
                ]),
            ],
        ]);
    }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->team_color = \PkgClient\Protocol\Enum\TeamColor::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 13) {
                ...
                $innerSize    = $reader->readVarint($stream);
                $innerMessage = new \PkgClient\Protocol\Message\FortModifier();
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\FortDetailsResponse) {
