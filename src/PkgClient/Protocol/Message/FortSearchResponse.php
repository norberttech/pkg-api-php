...
/**
 * Protobuf message : PkgClient.Protocol.Message.FortSearchResponse
 */
class FortSearchResponse extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\PkgClient\Protocol\Message\FortSearchResponse\ItemAward>
     */
     ...
     * Set 'result' value
     *
     * @param \PkgClient\Protocol\Message\FortSearchResponse\Result $value
     */
    public function setResult(\PkgClient\Protocol\Message\FortSearchResponse\Result $value = null)
    {
        $this->result = $value;
    }
     ...
     *
     * @return \Protobuf\Collection<\PkgClient\Protocol\Message\FortSearchResponse\ItemAward>
     */
     ...
     *
     * @param \Protobuf\Collection<\PkgClient\Protocol\Message\FortSearchResponse\ItemAward> $value
     */
     ...
     *
     * @param \PkgClient\Protocol\Message\FortSearchResponse\ItemAward $value
     */
    public function addItemsAwarded(\PkgClient\Protocol\Message\FortSearchResponse\ItemAward $value)
    {
     ...
     */
    public function setPokemonDataEgg(\PkgClient\Protocol\Message\PokemonData $value = null)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.PkgClient.Protocol.Message.FortSearchResponse.Result'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'items_awarded',
                    ...
                    'type_name' => '.PkgClient.Protocol.Message.FortSearchResponse.ItemAward'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 3,
                    'name' => 'gems_awarded',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->result = \PkgClient\Protocol\Message\FortSearchResponse\Result::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 2) {
                ...
                $innerMessage = new \PkgClient\Protocol\Message\FortSearchResponse\ItemAward();
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\FortSearchResponse) {
