...
/**
 * Protobuf message : PkgClient.Protocol.Message.Pokemon
 */
class Pokemon extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \PkgClient\Protocol\Enum\PokemonMove
     */
    ...
    /**
     * deployed_fort_id optional int32 = 8
     *
     * @var int
     */
    ...
    /**
     * egg_km_walked_target optional int32 = 11
     *
     * @var int
     */
    ...
    /**
     * egg_km_walked_start optional int32 = 12
     *
     * @var int
     */
    ...
    /**
     * cp_multiplier optional int32 = 20
     *
     * @var int
     */
    ...
    /**
     * egg_incubator_id optional int32 = 25
     *
     * @var int
     */
    ...
    /**
     * additional_cp_multiplier optional int32 = 28
     *
     * @var int
     */
     ...
     */
    public function setPokemonType(\PkgClient\Protocol\Enum\PokemonId $value = null)
    {
     ...
     * Get 'move_1' value
     *
     * @return \PkgClient\Protocol\Enum\PokemonMove
     */
     ...
     */
    public function setMove1(\PkgClient\Protocol\Enum\PokemonMove $value = null)
    {
        $this->move_1 = $value;
    }
     ...
     * @param \PkgClient\Protocol\Enum\PokemonMove $value
     */
    public function setMove2(\PkgClient\Protocol\Enum\PokemonMove $value = null)
    {
        $this->move_2 = $value;
    }
     ...
     * @param int $value
     */
    public function setPokeball($value = null)
    {
        $this->pokeball = $value;
    }
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->deployed_fort_id !== null) {
            ...
            $writer->writeVarint($stream, $this->deployed_fort_id);
        }
        ...
        if ($this->egg_km_walked_target !== null) {
            ...
            $writer->writeVarint($stream, $this->egg_km_walked_target);
        }

        if ($this->egg_km_walked_start !== null) {
            $writer->writeVarint($stream, 96);
            $writer->writeVarint($stream, $this->egg_km_walked_start);
        }
        ...
        if ($this->cp_multiplier !== null) {
            ...
            $writer->writeVarint($stream, $this->cp_multiplier);
        }

        if ($this->pokeball !== null) {
            $writer->writeVarint($stream, 168);
            $writer->writeVarint($stream, $this->pokeball);
        }
        ...
        if ($this->egg_incubator_id !== null) {
            ...
            $writer->writeVarint($stream, $this->egg_incubator_id);
        }
        ...
        if ($this->additional_cp_multiplier !== null) {
            ...
            $writer->writeVarint($stream, $this->additional_cp_multiplier);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->pokemon_type = \PkgClient\Protocol\Enum\PokemonId::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 6) {
                ...
                $this->move_1 = \PkgClient\Protocol\Enum\PokemonMove::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 7) {
                ...
                $this->move_2 = \PkgClient\Protocol\Enum\PokemonMove::valueOf($reader->readVarint($stream));
            ...
            if ($tag === 8) {
                ...
                $this->deployed_fort_id = $reader->readVarint($stream);
            ...
            if ($tag === 11) {
                ...
                $this->egg_km_walked_target = $reader->readVarint($stream);
            ...
            if ($tag === 12) {
                ...
                $this->egg_km_walked_start = $reader->readVarint($stream);
            ...
            if ($tag === 20) {
                ...
                $this->cp_multiplier = $reader->readVarint($stream);
            ...
            if ($tag === 21) {
                ...
                $this->pokeball = $reader->readVarint($stream);
            ...
            if ($tag === 25) {
                ...
                $this->egg_incubator_id = $reader->readVarint($stream);
            ...
            if ($tag === 28) {
                ...
                $this->additional_cp_multiplier = $reader->readVarint($stream);
    ...
    public function serializedSize(\Protobuf\ComputeSizeContext $context)
    {
        ...
        if ($this->deployed_fort_id !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->deployed_fort_id);
        }
        ...
        if ($this->egg_km_walked_target !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->egg_km_walked_target);
        }

        if ($this->egg_km_walked_start !== null) {
            $size += 1;
            $size += $calculator->computeVarintSize($this->egg_km_walked_start);
        }
        ...
        if ($this->cp_multiplier !== null) {
            $size += 2;
            $size += $calculator->computeVarintSize($this->cp_multiplier);
        }

        if ($this->pokeball !== null) {
            $size += 2;
            $size += $calculator->computeVarintSize($this->pokeball);
        }
        ...
        if ($this->egg_incubator_id !== null) {
            $size += 2;
            $size += $calculator->computeVarintSize($this->egg_incubator_id);
        }
        ...
        if ($this->additional_cp_multiplier !== null) {
            $size += 2;
            $size += $calculator->computeVarintSize($this->additional_cp_multiplier);
        }
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\Pokemon) {
