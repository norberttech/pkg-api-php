...
/**
 * Protobuf message : PkgClient.Protocol.Message.ReleasePokemonRequest
 */
class ReleasePokemonRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\ReleasePokemonRequest) {
