...
/**
 * Protobuf message : PkgClient.Protocol.Message.CaptureScore
 */
class CaptureScore extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\PkgClient\Protocol\Enum\ActivityType>
     */
     ...
     *
     * @return \Protobuf\Collection<\PkgClient\Protocol\Enum\ActivityType>
     */
     ...
     *
     * @param \Protobuf\Collection<\PkgClient\Protocol\Enum\ActivityType> $value
     */
     ...
     *
     * @param \PkgClient\Protocol\Enum\ActivityType $value
     */
    public function addActivityType(\PkgClient\Protocol\Enum\ActivityType $value)
    {
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.PkgClient.Protocol.Enum.ActivityType'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 2,
                    'name' => 'xp',
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 1) {
                ...
                $this->activity_type->add(\PkgClient\Protocol\Enum\ActivityType::valueOf($reader->readVarint($stream)));
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Message\CaptureScore) {
