...
/**
 * Protobuf message : PkgClient.Protocol.Communication.Request
 */
class Request extends \Protobuf\AbstractMessage
{
     ...
     *
     * @var \Protobuf\Collection<\PkgClient\Protocol\Communication\Request\Requests>
     */
     ...
     *
     * @var \PkgClient\Protocol\Communication\Request\Unknown6
     */
     ...
     *
     * @var \PkgClient\Protocol\Communication\Request\AuthInfo
     */
    protected $auth = null;
     ...
     * Get 'requests' value
     *
     * @return \Protobuf\Collection<\PkgClient\Protocol\Communication\Request\Requests>
     */
     ...
     * Set 'requests' value
     *
     * @param \Protobuf\Collection<\PkgClient\Protocol\Communication\Request\Requests> $value
     */
     ...
     *
     * @param \PkgClient\Protocol\Communication\Request\Requests $value
     */
    public function addRequests(\PkgClient\Protocol\Communication\Request\Requests $value)
    {
     ...
     * Get 'unknown6' value
     *
     * @return \PkgClient\Protocol\Communication\Request\Unknown6
     */
     ...
     * Set 'unknown6' value
     *
     * @param \PkgClient\Protocol\Communication\Request\Unknown6 $value
     */
    public function setUnknown6(\PkgClient\Protocol\Communication\Request\Unknown6 $value = null)
    {
        $this->unknown6 = $value;
    }
     ...
     * Get 'auth' value
     *
     * @return \PkgClient\Protocol\Communication\Request\AuthInfo
     */
     ...
     * Set 'auth' value
     *
     * @param \PkgClient\Protocol\Communication\Request\AuthInfo $value
     */
    public function setAuth(\PkgClient\Protocol\Communication\Request\AuthInfo $value = null)
    {
        $this->auth = $value;
    }
        ...
        return \google\protobuf\DescriptorProto::fromArray([
            ...
            'field'     => [
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type_name' => '.PkgClient.Protocol.Communication.Request.Requests'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 6,
                    'name' => 'unknown6',
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_MESSAGE(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.PkgClient.Protocol.Communication.Request.Unknown6'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 7,
                    'name' => 'latitude',
                ...
                \google\protobuf\FieldDescriptorProto::fromArray([
                    ...
                    'type' => \google\protobuf\FieldDescriptorProto\Type::TYPE_MESSAGE(),
                    'label' => \google\protobuf\FieldDescriptorProto\Label::LABEL_OPTIONAL(),
                    'type_name' => '.PkgClient.Protocol.Communication.Request.AuthInfo'
                ]),
                \google\protobuf\FieldDescriptorProto::fromArray([
                    'number' => 11,
                    'name' => 'auth_ticket',
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->direction === null) {
            throw new \UnexpectedValueException('Field "\\PkgClient\\Protocol\\Communication\\Request#direction" (tag 1) is required but has no value.');
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 4) {
                ...
                $innerMessage = new \PkgClient\Protocol\Communication\Request\Requests();
            ...
            if ($tag === 6) {
                ...
                $innerSize    = $reader->readVarint($stream);
                $innerMessage = new \PkgClient\Protocol\Communication\Request\Unknown6();
            ...
            if ($tag === 10) {
                ...
                $innerSize    = $reader->readVarint($stream);
                $innerMessage = new \PkgClient\Protocol\Communication\Request\AuthInfo();
    ...
    {
        if ( ! $message instanceof \PkgClient\Protocol\Communication\Request) {
